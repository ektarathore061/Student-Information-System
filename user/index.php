		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="form-group col-md-4">
					<input type="text" name="firstname" id="firstname" placeholder="Chiya" autofocus required class="form-control form-control-sm form-control-border" value="<?= isset($firstname) ? $firstname :"" ?>">
				...
				<div class="form-group col-md-4">
					<input type="text" name="lastname" id="lastname" placeholder="Jamwal" required class="form-control form-control-sm form-control-border" value="<?= isset($lastname) ? $lastname :"" ?>">
			...
			<div class="row">
				<div class="form-group col-md-10">
					<input type="email" name="email" id="email" placeholder="chiyajamwal27@gmail.com" required class="form-control form-control-sm form-control-border" value="<?= isset($email) ? $email :"" ?>">
